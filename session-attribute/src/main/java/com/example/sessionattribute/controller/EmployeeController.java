...
public class EmployeeController {
    ...
    public String processEmployee(@ModelAttribute("employee")Employee employee, BindingResult result){
        if (result.hasErrors()){
            return "employeeForm";
        }else {
    ...
    public String processDepartment(@ModelAttribute("department")Department department,BindingResult result){
        if (result.hasErrors()){
            return "departmentForm";
        }else {
    ...
    public String processAllData(@ModelAttribute("address")Address address,
